export default [
    ...
    {
        name: "2",
        description: "Loremaucibus tpat vitae urna. Maurac efficitur faucibus, lectus risus feugiat magna, ac hendrerit libero mauris at neque. Curabitur placerat a enim non volutpat. Maecenas eu arcu felis.",
        location: "Trondheim",
        date: new Date(),
        capacity: 4000
    },
